  ...
  return (
    <div className="flex flex-col items-center justify-center px-6 py-16 text-center animate-fade-in">
      <div className="relative mb-5">
        <div className="absolute inset-0 -m-2 rounded-2xl bg-brand-100/60 blur-xl dark:bg-brand-500/10" />
        <div className="relative flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-50 to-ink-100 ring-1 ring-ink-200 dark:from-brand-500/15 dark:to-ink-800 dark:ring-white/[0.08]">
